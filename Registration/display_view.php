        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 mt-5 mb-4 ml-4">
                    ...
                    <div class="text-center p-3 mt-4 mb-5">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active post-s-l" id="posts" role="tabpanel" aria-labelledby="posts-tab">
                            ...
                            <?php
                                        ...
                                        <a href="/Registration/Invest/rate.php" class="col-md-4" style="color: black; margin-left: 250px;">View Details</a>
                                        <div class="col-md-4" style="color: black;" >Min. Investment: ' . $row['project_cost'] . '$' . '</div>
                                    </div>
