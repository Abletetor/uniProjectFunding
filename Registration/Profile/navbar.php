...
if (!isset($_SESSION['userId']) && !isset($_SESSION['emailId'])) {
  ...
  header("<location:Profunding>Nav-bar.php");
} else {


  echo '        <nav class="navbar sticky-top navbar-expand-md" style="background-color:#000e49">
            <a class="navbar-brand" href="profile.php">
                <img src="assets/img/pr5.png" class="mt-2" height="100" alt="">
            </a>
