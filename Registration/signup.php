    ...
    <div class="container text-dark">
      <div class="row">
        <div class="col offset text-center font-weight-bold">
          <form id="signup-form" action="signup.inc.php" method='post' enctype=" multipart/form-data">
            <h1 class="mt-5 text-dark" style="text-shadow:0px 12px 9px #30733f;color:#090929;">Signup Form
            </h1>
            <br>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-12 ">
                <img id="blah" src="#" alt="your image" style="height: 180px; width: 185px; object-fit: cover;border-radius:50%;box-shadow: 2px 2px 20px 1px blue;">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="add" name="add" maxlength="1000" placeholder="Address/ City/ State/ Pincode">
              </div>
            </div>
            ...
            <div class="form-row" id="this_i_inv" style="display:none">
              ...
              <div class="form-group col-md-4">
                <label for="amt_in_y">Investment Budget For The Year (In $)</label><br>
            ...
            <div class="form-row" id="this_t_us_w" style="display:none">
              <div class="form-group col-md-12">
                ...
                <textarea class="form-control" id="t_us_w" name="t_us_w" rows="3" maxlength="1000" placeholder="Tell Us Where Have You Invested"></textarea>
              </div>
            </div>
