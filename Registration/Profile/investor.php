    ...
    <div id="content" style="display: none">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 mt-5 mb-4 ml-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="row" style="color: black;font-size: larger;text-shadow:0px 12px 9px #30733f;color:#090929;">
                                        <div class="col"><i class="fa">Follower</i>
                                            <hr>
                                        </div>
                    ...
                    <ul class="nav nav-tabs justify-content-sm-end" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="posts-tab" data-toggle="tab" href="#posts" role="tab" aria-controls="posts" aria-selected="true">Recent Posts</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active post-s-l" id="posts" role="tabpanel" aria-labelledby="posts-tab">
                            ...
                            if ($row_uf['follow'] === 0) {
                                ...
                                $sql = "select post_id,post_title,post_img,post_by,post_date,post_content,post_type,post_tag,f.name,f.profile_pic,project_cost,interest_percentage from posts p,fundraiser as f where p.post_by in " . $sto_st . " and f.fundraiser_email_id in " . $sto_st . " and p.post_by = f.fundraiser_email_id and post_type in ('protected','public')
                                ...
                                if (!mysqli_stmt_prepare($stmt, $sql)) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo '                            <div class="container mt-3 border-primary p-4 rounded mb-3"height:50 style="text-align:justify;box-shadow:inset 0px 0px 10px 6px #b7a7ff8a">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <a href="view_profile.php?view-profile_i=' . $row['post_by'] . '"><div class="row">
                                                        <div class="col-sm-2">
                                                        <img style=" border-radius: 50%;height: 60px;width: 42px;"src="uploads/' . $row['profile_pic'] . '" alt="">
                                                        </div>
                                                    <div class="col-sm-4">
                                        ...
                                        if ($val_of_in_v) {
                                            echo '<i class="fa fa-check mr-1" style="font-size: 19px;font-style: oblique;color:#6301ff;"></i> Interested</small>';
                                        } else {
                            ...
                            <?php
                                        echo ' 
                                                ...
                                                <a href="display_invests.php?post_id='. $row['post_id'].'" class="col-md-4" style="color:
                            black; margin-left: 280px; margin-top: 21px;">View Details</a>
                            <div class="col-md-4" style="color: black; margin-top: -21px;">Min. Investment: ' . $row['project_cost'] . '$'
                                            . '</div>
                        </div>
