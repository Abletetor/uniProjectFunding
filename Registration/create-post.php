                    ...
                    <form id="signup-form" action="create-post.inc.php" method='post' 
                        ...
                        <div class="form-group col-md-10">
                          ...
                          <div class="form-group col-md-2">
                            ...
                            <input type="number" class="form-control" id="project_cost" name="project_cost" placeholder="Enter Project Cost">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="interest_percentage">Interest Percentage (%)</label>
                            <input type="number" class="form-control" id="interest_percentage" name="interest_percentage" placeholder="Enter Interest Percentage">
                        </div>
                      </div>
                          <div class="form-group col-md-12">
