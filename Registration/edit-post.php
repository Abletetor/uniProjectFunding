                ...
                <div class="row">
                    ...
                    <form id="signup-form" action="edit-post.inc.php?p_id=<?php echo $_GET['p_id'];?>" method='post' 
                        ...
                        <div class="form-group col-md-12">
                            ...
                            value="<?php echo $rowi['post_title'];?>" placeholder="<?php echo $rowi['post_title'];?>">
                          </div>
                        <div class="form-group col-md-10">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            placeholder="<?php echo $rowi['project_cost'];?>">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="interest_percentage">Interest Percentage (%)</label>
                            <input type="number" class="form-control" id="interest_percentage" name="interest_percentage" placeholder="<?php echo $rowi['interest_percentage'];?>"
                        </div>
                    </div>
