...
<body styl="background: url('Hunter/img/backgroundr.jpg') center;background-size: cover;">
  <!--start from here-->
  ...
  <section id="cover">
    <div id="cover-caption">
      <div class="container text-dark font-weight-bold">
        <div class="row">
          <div class="col">
            <h2 class=" mb-3 h1"><b>Funding Has Never Been Easy!</b></h2>
            <!-- <img src='Hunter\img\ek.png' style="width: 150px; object-fit: cover;border-radius:50%;box-shadow: inset 2px 2px 20px 1px blue;"> -->
            <br>
