...
if (isset($_POST['idea-submit']))
{
    ...
    {   if($registerd_s=='yes'){
        ...
        $sql = "insert into posts(post_title, stage, resgister_name,post_img,post_by, post_date, post_content,post_type,post_tag,pitch_file, project_cost, interest_percentage) "
                . "values (?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        {
            mysqli_stmt_bind_param($stmt, "ssssssssssss", $post_title,$s_level,$registerd_s,
            $FileNameNew,$post_by,$post_date,$post_content,
            $post_type,$post_tag,$PitchFileNameNew,$projectCost,$interestPercentage);
