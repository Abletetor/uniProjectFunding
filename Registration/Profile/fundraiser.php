<body onload="pageLoad()">
    ...
    <div id="loader-wrapper" style="background: url() center;background-size: cover">
        <img src='Hunter/img/ek.png' id='loader-logo' style="height: 250px; width: 250px; object-fit: cover;border-radius:50%;box-shadow: inset 2px 2px 20px 1px blue;">
        ...
        <img src='Hunter/img/pr5.png' id='loader-logo' style="width: 370px;margin-top:25em">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 mt-5 mb-4 ml-4" style="background: repeating-linear-gradient( 45deg , #fff6e5, #ffebde 155px) fixed center;">
                    ...
                    <div class="text-center p-3 mt-4 mb-5" style="background: repeating-linear-gradient( 45deg , #aad8ff, #c8e0ff 155px) fixed center;border-radius: 22px;/*background: repeating-linear-gradient( 45deg , #fff6e5, #ffebde 155px) fixed center;*/">
                        <h2 class='text-muted mt-3 ml-2 mb-4'><b style="text-shadow:0px 12px 9px #30733f;color:#090929;">Welcome
                                <?php echo ucwords($_SESSION['name']); ?> </b></h2>
                        <br>
                        <div class="container">
                            <div class="row">
                                <div class="col text-left">
                                    ...
                                    $sql = "select post_id,post_title,post_img,post_by,post_date,post_content,post_type,post_tag
                                            ,f.name,f.profile_pic,project_cost,interest_percentage 
                                            from posts,fundraiser as f
                                            where f.fundraiser_email_id=post_by AND f.fundraiser_email_id = '" . $_SESSION['emailId'] . "'
                                ...
                                <div class="col">
                                    <div class="row" style="color: black;font-size: larger;text-shadow:0px 12px 9px #30733f;color:#090929;">
                                        <div class="col"><i class="fa">Posts</i>
                                            <hr>
                                        </div>
                                        <div class="col"><i class="fa">Followers</i>
                                            <hr>
                                        </div>
                                        <div class="col"><i class="fa">Following</i>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row" style="color: black;">
                                        <div class="col"><i class="fa"><?php echo $num_of_p_u; ?></i>
                                            <hr>
                                        </div>
                                        <div class="col"><i class="fa"><?php echo $row_ufo['follow']; ?></i>
                                            <hr>
                                        </div>
                                        <div class="col"><i class="fa"><?php echo $row_uf['follow']; ?></i>
                                            <hr>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <ul class="nav nav-tabs justify-content-sm-end" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" id="oi_posts-tab" data-toggle="tab" href="#oi_posts" role="tab" aria-controls="oi_posts" aria-selected="false">Public Posts</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " id="posts-tab" data-toggle="tab" href="#posts" role="tab" aria-controls="posts" aria-selected="true">My Posts</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" id="o_posts-tab" data-toggle="tab" href="#o_posts" role="tab" aria-controls="o_posts" aria-selected="false">Recent Posts</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade  post-s-l" id="posts" role="tabpanel" aria-labelledby="posts-tab">
                        ...
                        <?php
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <div class="row">
                                                ...
                                                <a href="edit-post.php?o_ty=edit&u_id=' . $row['post_by'] . '&p_id=' . $row['post_id'] . '">Edit Post</a><br>
                                                <a href="edit-post.php?o_ty=delete&&u_id=' . $row['post_by'] . '&p_id=' . $row['post_id'] . '">Delete</a>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6 txt-dark font-weight-light" >Min Investment: ' . $row['project_cost'].'GHC' . '</div>
                                                <div class="form-group col-md-6 txt-dark font-weight-light" >Interest Percentage: ' . $row['interest_percentage'].'%' . '</div> 
                        ...
                        <div class="tab-pane fade show active post-s-l" id="o_posts" role="tabpanel" aria-labelledby="o_posts-tab">
                        ...
                        <div class="tab-pane fade post-s-l" id="oi_posts" role="tabpanel" aria-labelledby="oi_posts-tab">
                            ...
                            $sql = "select post_id,post_title,post_img,post_by,post_date,post_content,post_type,post_tag
                                    ...
                                    from posts,fundraiser as f
                                    where  post_type='public' AND f.fundraiser_email_id=post_by AND f.fundraiser_email_id <>'" . $_SESSION['emailId'] . "'
                                    order by post_id desc;";
                            $stmt = mysqli_stmt_init($conn);
